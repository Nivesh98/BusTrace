...
const SeatMapReservation = ({busID, selectedDate}) => {
  ...
  //       const fetchedSeats = await authService.getSeatsForDriverReservation(
  //         driverId,
  //         selectedDate,
  //       );
    ...
    const newSeats = seats.map((seat, i) => {
      if (i === index) {
        ...
        if (
          ...
          //   authService.updateSeatStatusReservation(
          //     busID.busID,
          //     index,
          //     'available',
          //     null,
  ...
  const proceedPayment = () => {
    ...
    if (userId !== undefined) {
      //   authService.updateSeatStatusReservationProceed(
      //     busID.busID,
      //     'booked',
      //     userId,
      //     selectedDate,
...
export default SeatMapReservation;
